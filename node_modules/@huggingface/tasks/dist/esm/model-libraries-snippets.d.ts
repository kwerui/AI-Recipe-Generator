...
export declare const ltx: (model: ModelData) => string[];
...
export declare const litert_lm: (model: ModelData) => string[];
...
export declare const nobg: (model: ModelData) => string[];
...
export declare const mobilint: (model: ModelData) => string[];
